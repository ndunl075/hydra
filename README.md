...
- **Packs** bundle roles, gates, MCP servers and skills for one kind of work. Hydra ships **Coding** and **Research**, and you can add your own. Turning one on in **Hydra Settings → Packs** shows everything it would run first, and saves `.hydra/packs.json` for your team. A lane, plan job or head can then take a role such as Builder, Reviewer or Researcher. See [Packs](docs/Heads.md#packs).
