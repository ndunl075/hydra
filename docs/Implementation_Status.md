...
| M3 structured sessions | Provider diagnostics implemented; adapters next | Explicit bounded public CLI help/version probes, advertised-versus-verified capability labels, local raw diagnostics, safe process cleanup. Structured streaming, approvals, resume, interruption, and usage are not connected yet |
