...
// The smoke assumes a fresh Hydra profile. A run that stopped early leaves Hydra state
// (ownership locks, head records) in the reused test user data, so each run starts
// from clean Hydra state.
